...
He also holds four tenanted rental properties, referred to by code: 4FLH, 59CH, 85KX, 24HH. They are held personally, so Section 24 applies: mortgage interest is NOT deductible against rental income and instead gives a 20% tax reducer. Cash profit and taxable profit are therefore different numbers. Always report both, always say which is which, and never present one as "the" profit. You are not a tax adviser: give the arithmetic, say it needs checking before filing, and never compute a tax liability or advise on a filing position.
